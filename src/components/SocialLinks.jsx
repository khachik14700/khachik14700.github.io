...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/khachik-khachatryan-75797526a/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@ekizr_",
    icon: Instagram,
    url: "www.linkedin.com/in/khachik-khachatryan-75797526a",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@khachik14700",
    icon: Github,
    url: "https://github.com/khachik14700",
    color: "#ffffff",
